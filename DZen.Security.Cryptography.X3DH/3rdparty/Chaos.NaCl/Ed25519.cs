...
namespace Chaos.NaCl
{
    internal static class Ed25519
    {
        ...
        internal static bool Verify(ArraySegment<byte> signature, ArraySegment<byte> message, ArraySegment<byte> publicKey)
        {
        ...
        internal static bool Verify(byte[] signature, byte[] message, byte[] publicKey)
        {
            if (signature == null)
        ...
        internal static void Sign(ArraySegment<byte> signature, ArraySegment<byte> message, ArraySegment<byte> expandedPrivateKey)
        {
        ...
        internal static byte[] Sign(byte[] message, byte[] expandedPrivateKey)
        {
        ...
        internal static byte[] ExpandedPrivateKeyFromSeed(byte[] privateKeySeed)
        {
            byte[] privateKey;
            byte[] publicKey;
            KeyPairFromSeed(out publicKey, out privateKey, privateKeySeed);
        ...
        internal static void KeyPairFromSeed(out byte[] publicKey, out byte[] expandedPrivateKey, byte[] privateKeySeed)
        {
        ...
        internal static void KeyPairFromSeed(ArraySegment<byte> publicKey, ArraySegment<byte> expandedPrivateKey, ArraySegment<byte> privateKeySeed)
        {
